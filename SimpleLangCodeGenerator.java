...
public class SimpleLangCodeGenerator extends AbstractParseTreeVisitor<String> implements SimpleLangVisitor<String>
{
    ...
    @Override
    public String visitVarDeclExpr(SimpleLangParser.VarDeclExprContext ctx) {
        return null;
    }
    ...
    public String visitWhileExpr(SimpleLangParser.WhileExprContext ctx) {
        ...
        String startLabel = String.format("label_%d", labelCounter++);
        String endLabel = String.format("label_%d", labelCounter++);
        ...
        // Invert the result of the condition to use with JumpTrue
        sb.append("Invert\n");

        // If the condition is false (after inversion), jump to endLabel
        sb.append(String.format("JumpTrue %s\n", endLabel));
